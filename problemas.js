...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const problemListSection = document.getElementById("problem-list");
    ...
    const solutions = {
        ...
        "Olor desagradable en el sustrato": "Un olor algo desagradable, a humedad o a podrido que proviene de la tierra es un fuerte indicador de riego excesivo y probablemente la presencia de bacterias anaeróbicas u hongos. Deja que la tierra se seque considerablemente antes de volver a regar. Asegúrate de que la maceta tenga un drenaje adecuado. Considera trasplantar con tierra fresca y con buen drenaje."
    };

    // Aqui se definen las imagenes para cada problema
    const solutionImages = {
        "Hojas amarillas": "problemas/hojas-amarillas.jpg",
        "Manchas en las hojas": "problemas/manchas-hojas.jpg",
        "Hojas marchitas": "problemas/hojas-marchitas.jpg",
        "Puntas de las hojas marrones": "problemas/puntas-marrones.jpg",
        "Crecimiento alargado y débil": "problemas/-",
        "Polvo blanco en las hojas y tallos": "problemas/polvo-blanco.jpg",
        "Áfidos": "problemas/afidos.jpg",
        "Moscas/mosquitos": "problemas/mosquito.jpg",
        "Raíces blandas y marrones": "https://via.placeholder.com/400x300?text=Raices+Blandas",
        "Crecimiento lento": "https://via.placeholder.com/400x300?text=Crecimiento+Lento",
        "Hojas rizadas": "https://via.placeholder.com/400x300?text=Hojas+Rizadas",
        "Sustancia pegajosa en las hojas": "https://via.placeholder.com/400x300?text=Sustancia+Pegajosa",
        "Falta de floración": "https://via.placeholder.com/400x300?text=Falta+Floracion",
        "Venas de las hojas amarillas": "https://via.placeholder.com/400x300?text=Venas+Amarillas",
        "Agujeros en las hojas": "https://via.placeholder.com/400x300?text=Agujeros+Hojas",
        "Bordes de las hojas quemados": "https://via.placeholder.com/400x300?text=Bordes+Quemados",
        "Caída repentina de hojas": "https://via.placeholder.com/400x300?text=Caida+Hojas",
        "Hojas pálidas o sin color": "https://via.placeholder.com/400x300?text=Hojas+Palidas",
        "Flores que se marchitan rápidamente": "https://via.placeholder.com/400x300?text=Flores+Marchitas",
        "Telarañas finas en las hojas": "https://via.placeholder.com/400x300?text=Telaranas+Finas",
        "Bultos anormales en hojas o tallos": "https://via.placeholder.com/400x300?text=Bultos+Anormales",
        "Base del tallo blanda o ennegrecida": "https://via.placeholder.com/400x300?text=Base+Tallo+Blanda",
        "Cristales blancos en el sustrato": "https://via.placeholder.com/400x300?text=Cristales+Blancos",
        "Hojas jóvenes muy pequeñas": "https://via.placeholder.com/400x300?text=Hojas+Pequenas",
        "Hojas deformadas o retorcidas": "https://via.placeholder.com/400x300?text=Hojas+Deformadas",
        "Barrenadores (túneles en hojas)": "https://via.placeholder.com/400x300?text=Barrenadores",
        "Olor desagradable en el sustrato": "https://via.placeholder.com/400x300?text=Olor+Desagradable"
    };
    ...
    backToListButton.addEventListener('click', function() {
        problemListSection.scrollIntoView({
            behavior: 'smooth',
            block: 'start'
        });
    });
